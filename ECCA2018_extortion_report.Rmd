...
kable(chisq_tb(biv_inc_rels_noNA, stars = TRUE), "pandoc",
      caption = "Chi-square tests between 'complied_bin_NA' and a set of DV")
...
kable(chisq_tb(biv_inc_rels, stars = TRUE), "pandoc",
      caption = "Chi-square tests between 'complied_bin' and a set of DV")
...
lapply(inc_cross_IV_NA, function(x) kable(chisq_tb(x, stars = TRUE), "pandoc",
                                          caption = "Chi-square tests between DVs"))
...
mmm1tmb <- update(mm1tmb, . ~ . + (1|NOM_ENT/CVE_UNICA) - (1|CVE_UNICA))

tmbresults(mmm1tmb)

dropalltest(mmm1tmb)

lrtest(mmm1tmb, mm1tmb)
...
mm1lme4 <- glmer(update(compliance_formula, . ~ . + (1|CVE_UNICA)), family = "binomial", data = enve_nona)

tmbresults(mm1lme4)

lrtest(mm1lme4, m1)

mmm1lme4 <- glmer(update(compliance_formula, . ~ . + (1|NOM_ENT/CVE_UNICA)), family = "binomial", data = enve_nona)

tmbresults(mmm1lme4)

lrtest(mmm1lme4, mm1lme4)
