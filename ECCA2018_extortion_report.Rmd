...
This script only focuses on running the favoured regression model on incident-level data using clustered standard errors.

Will explore the different options regarding packages.

As using clustered se, multilevel framework is not required.
