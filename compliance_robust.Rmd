...
Do the best model and checks using RMS first. Then Zelig.
...
Come up with a systematic approach to calculate robust clustered SEs using vcovCL, vcovBS, and bootCL
...
m1CL <- summaryCL(m1, ~ CVE_UNICA)
m1CL

m1_stepCL <- summaryCL(m1_step, ~ CVE_UNICA)
m1_stepCL
...
m1_incCL <- summaryCL(m1_inc, ~ CVE_UNICA)
...
m1_busCL <- summaryCL(m1_bus, ~ CVE_UNICA)
m1_busCL

# state level vars only

m1_stateCL <- summaryCL(m1_state, ~ CVE_UNICA)
m1_stateCL

#### progressive

m1_inc_busCL <- summaryCL(m1_inc_bus, ~ CVE_UNICA)
m1_inc_busCL
...
m1BS <- summaryCL(m1, ~ CVE_UNICA, boots = TRUE)
m1BS

m1_stepBS <- summaryCL(m1_step, ~ CVE_UNICA, boots = TRUE)
m1_stepBS
...
m1_incBS <- summaryCL(m1_inc, ~ CVE_UNICA, boots = TRUE)
m1_incBS
...
m1_busBS <- summaryCL(m1_bus, ~ CVE_UNICA, boots = TRUE)
m1_busBS

# state level vars only

m1_stateBS <- summaryCL(m1_state, ~ CVE_UNICA, boots = TRUE)
m1_stateBS

#### progressive

m1_inc_busBS <- summaryCL(m1_inc_bus, ~ CVE_UNICA, boots = TRUE)
m1_inc_busBS
